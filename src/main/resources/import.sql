...
INSERT INTO `item` (item_id,contenido,guia,nombre,registro_calificado_id) VALUES ('1','<h1>Documento Institucional</h1><p><b>1. Denominación del Programa</b></p><p>La institución deberá especificar la denominación o nombre del programa, en correspondencia con el título que se va a otorgar, el nivel de formación, los contenidos curriculares del programa y el perfil del egresado; lo anterior de acuerdo con la normatividad vigente.</p><p>Los programas técnicos profesionales y tecnológicos deben adoptar denominaciones que correspondan con las competencias propias de su campo de conocimiento, de tal manera que su denominación sea diferenciable y permita una clara distinciónlas ocupaciones, disciplinas y profesiones.</p>','La institución deberá especificar ','Denominación del Programa','1');
INSERT INTO `item` (item_id,contenido,guia,nombre,registro_calificado_id) VALUES ('2','','La institución deberá presentar una justificación que sustente el contenido curricular, los perfiles de egreso y la (s) modalidad (es), en que se desea ofrecer el programa para que este sea pertinente al desarrollo social, cultural, ambiental, económico y científico, frente a las necesidades del país y la región, con fundamento en un estudio que por lo menos contenga los siguientes componentes','Justificación del Programa','1');
